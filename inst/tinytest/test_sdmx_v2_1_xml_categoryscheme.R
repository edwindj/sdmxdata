...
doc <- xml2::read_xml(system.file("extdata", "categoryscheme.xml", package = "sdmxdata"))

d <- sdmxdata:::xml_categoryscheme(doc)
...
d_flattened <- sdmxdata:::sdmx_v2_1_xml_categories_flattened(doc)
